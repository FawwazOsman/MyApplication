...
import com.example.myapplication.databinding.ActivityWordleBinding
...
class WordActivity : AppCompatActivity() {
    ...
    private val list = listOf("fruit","dubai","break","honda","boats","cloud","signal","sand","life","crate")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonWord = findViewById<Button>(R.id.buttonWord)
